    ...
    <View className="bg-white flex-1">
      <View className="relative py-4 shadow-sm">
        <TouchableOpacity
          ...
          <Feather name={'arrow-left'} size={24} style={{color: 'white'}} />
        </TouchableOpacity>
        <View>
      ...
      <View
        style={{backgroundColor: themeColors.bgColor(0.2), padding: 30}}
        className="flex-row px-4 items-center">
        <Text className="flex-1 pl-4 text-center font-bold">
          ...
          return (
            <View
              ...
              <TouchableOpacity
                ...
                style={{backgroundColor: themeColors.bgColor(1)}}>
                <Feather name={'minus'} size={24} style={{color: 'white'}} />
              </TouchableOpacity>
            </View>
          );
        })}
...
//<Image className="w-20 h-20 rounded-full" source={require('')} />
